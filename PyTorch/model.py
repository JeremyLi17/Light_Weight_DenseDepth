...
class Decoder(nn.Module):
    # densenet169- 1664, densenet121: 1024
    def __init__(self, num_features=1024, decoder_width=1.0):
        ...
        self.up1 = UpSample(skip_input=features//1 + 256,
                            output_features=features//4)
        self.up2 = UpSample(skip_input=features//4 + 128,
                            output_features=features//8)
        self.up3 = UpSample(skip_input=features//8 + 64,
                            output_features=features//8)
...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.original_model = models.densenet121(pretrained=False)
